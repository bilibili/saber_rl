...
__all__ = ["CheckpointConfig", "ProfileConfig", "BaseModelConfig", "BiliCheckpointConfig"]
...
@dataclass
class BiliCheckpointConfig(CheckpointConfig):
    """Configuration for model checkpointing.

    The inheritance from CheckpointConfig provides omegaconf.DictConfig-like interface for a dataclass config.

    Args:
        export (bool): Whether to export checkpoints.
        default_local_dir (str): Parent-dir for local checkpoints, refer to "trainer.default_local_dir".
        delete_after_upload (bool): Whether to delete local checkpoints after uploading to remote.
    """
