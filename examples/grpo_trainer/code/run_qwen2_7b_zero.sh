set -x
MODEL_PATH=/workspace/models/Qwen2.5-Coder-7B
DATA_PATH_PREFIX=/workspace/data/code-contests/
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="${DATA_PATH_PREFIX}"/train_xiugai.parquet \
    data.val_files="${DATA_PATH_PREFIX}"/test_xiugai.parquet \
    ...
    trainer.project_name='GRPO_CODE' \
    trainer.experiment_name='Qwen2.5-7B-code-contests' \
