...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="${DATA_PATH_PREFIX}"/ppl3_7_train.parquet \
    ...
    trainer.experiment_name='Qwen2.5-7B-Instruct-1M-curriculum' \
...
# ps -ef | grep run_qwen2_7b_logic_puzzle.sh | grep -v grep | awk -F' ' '{print $2}' | xargs kill -9