...
from verl.utils.reward_score import math, sandbox, saber
...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source == 'sandbox':
        return sandbox.compute_score(solution_str, ground_truth, extra_info, sandbox_fusion_url, concurrent_semaphore)
    elif data_source == 'saber':
        return saber.saber_compute_score(solution_str, ground_truth, extra_info)
    else:
